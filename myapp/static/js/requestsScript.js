document.getElementById('AllocReqButton').addEventListener('click', function() {
    document.getElementById('allocation-requests-container').style.display = 'block';
    document.getElementById('deallocation-requests-container').style.display = 'none';
});

document.getElementById('DeallocReqButton').addEventListener('click', function() {
    document.getElementById('allocation-requests-container').style.display = 'none';
    document.getElementById('deallocation-requests-container').style.display = 'block';
});
